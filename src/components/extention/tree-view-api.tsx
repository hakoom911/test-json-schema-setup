    ...
    return (
      <AccordionPrimitive.Item value={value} className="relative">
         <AccordionPrimitive.Trigger
          ...
          aria-label="File"
          className={cn(
            "ml-[2%] items-center gap-1 cursor-pointer text-sm pr-1 rtl:pl-1 rtl:pr-0 rounded-md  duration-200 ease-in-out",
            {
...
export { Tree, Folder, File, Node,Leaf, CollapseButton, type TreeViewElement };
